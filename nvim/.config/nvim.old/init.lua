--- lots of this config has been taken from https://github.com/nvim-lua/kickstart.nvim/
--- but I didn't actually install kickstart neovim, as I want to install the plugins myself

-- sets the leader to space
vim.g.mapleader = " "
